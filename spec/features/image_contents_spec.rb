...
RSpec.feature "ImageContents", type: :feature, js:true do
  ...
  context "display existing image content" do
    ...
    it "can display thumbnails in image list" do
      visit_images 
      within("cap-image-selector .image-list") do
    ...
    it "can display image content for selected" do
      ...
      expect(page).to have_no_css("cap-image-selector .image-list li", :wait=>5)
  ...
  context "upload content" do
    ...
    it "can select file" do
      within("cap-image-editor .image-form") do
        ...
        expect(page).to have_css("cap-image-editor .image-select img.image-preview")
      end
    end
