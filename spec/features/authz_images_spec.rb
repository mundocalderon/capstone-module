    ...
    it "creates image" do
      within("cap-image-editor .image-form") do
        ...
        using_wait_time 20 do
          expect(page).to have_css("cap-image-loader img.image-preview")
          expect(page).to have_button("Create Image",:disabled=>false)
          click_button("Create Image")
          expect(page).to have_no_css("cap-image-loader img.image-preview")
          expect(page).to have_no_css("cap-image-loader")
