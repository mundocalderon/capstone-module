  ...
  describe "displays map" do
    it "displays map in tab" do
      within("cap-area[label='Map']") do
        ...
        within("div.tab-content cap-tab[label='Map']") do
          expect(page).to have_css("cap-current-subjects-map")
          expect(page).to have_css("cap-current-subjects-map div#map")
          expect(page).to have_css("cap-current-subjects-map div#map > div")
        end
      end
    end
  end
